      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if(request()->route()->getName() == "admin.paysallary" || request()->route()->getName() == "admin.sallaryRecord") { echo "active";} ?>"  href="#navbar-sallery" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-sallery">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if(request()->route()->getName() == "admin.officeexpense" || request()->route()->getName() == "admin.foodexpense") { echo "active";} ?>" href="#navbar-expence" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-expence">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if(request()->route()->getName() == "admin.record") { echo "active";} ?>" href="{{ route("admin.record", "All") }}">
